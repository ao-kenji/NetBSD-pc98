...
#define	sc_if		sc_ethercom.ec_if	/* network visible interface */
	...
	u_int16_t	(*sc_nic_get)
		__P((struct sn_softc *, u_int8_t));
	void		(*sc_nic_put)
		__P((struct sn_softc *, u_int8_t, u_int16_t));
	...
	void		(*sc_copytobuf)
		__P((struct sn_softc *, void *, u_int32_t, size_t));
	void		(*sc_copyfrombuf)
		__P((struct sn_softc *, void *, u_int32_t, size_t));
	void		(*sc_zerobuf)
		__P((struct sn_softc *, u_int32_t, size_t));
	 ...
	 */
	void	(*sc_hwreset) __P((struct sn_softc *));
	void	(*sc_hwinit) __P((struct sn_softc *));
	int	(*sc_mediachange) __P((struct sn_softc *));
	void	(*sc_mediastatus) __P((struct sn_softc *,
		    struct ifmediareq *));

	int	sc_enabled;	/* boolean; power enabled on interface */

	int	(*sc_enable) __P((struct sn_softc *));
	void	(*sc_disable) __P((struct sn_softc *));
...
void	snconfig __P((struct sn_softc *, int *, int, int, u_int8_t *));
int	snintr __P((void *));
