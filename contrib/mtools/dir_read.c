/*	$NecBSD: dir_read.c,v 1.5 1998/02/08 08:00:26 kmatsuda Exp $	*/
/*	$NetBSD$	*/
...
unsigned int num;
{
	...
	dir_entries = length * MSECTOR_SIZE / sizeof(struct directory);
#else
...
#ifdef MULTISECTORSIZE
	dir_entries = dir_len * MSECTOR_SIZE / sizeof(struct directory);
#else
