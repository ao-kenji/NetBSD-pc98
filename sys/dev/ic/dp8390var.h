/*	$NecBSD: dp8390var.h,v 1.4 1999/07/23 05:41:31 kmatsuda Exp $	*/
...
#else	/* PC-98 */
#define NIC_GET(t, h, reg)	bus_space_read_1((t), (h), (reg))
#define NIC_PUT(t, h, reg, val)	bus_space_write_1((t), (h), (reg), (val))
#endif	/* PC-98 */
