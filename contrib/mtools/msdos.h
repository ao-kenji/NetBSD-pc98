/*	$NecBSD: msdos.h,v 1.5 1998/02/08 08:00:58 kmatsuda Exp $	*/
/*	$NetBSD$	*/
...
#define	MSECTOR_SIZE_MAX 1024		/* sector size max */
#define	MSECTOR_SIZE	msector_size	/* = 512 or 1024 */
extern int	msector_size;
#else
...
#ifdef MULTISECTORSIZE
	unsigned char junk[476+512];	/* who cares? */
#else
